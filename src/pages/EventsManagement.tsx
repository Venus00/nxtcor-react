      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-400">
            Configure event detection and alarm settings
          </p>
        </div>
            ...
            <div className="px-4">
              <div className="flex gap-2 overflow-x-auto">
                ...
                <button
                  ...
                  className={`flex-shrink-0 py-3 px-4 rounded-t-lg font-medium text-sm transition-all ${
                    activeTab === 'motion'
