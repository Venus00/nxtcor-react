      ...
      <div className="bg-black/70 backdrop-blur-sm rounded-lg p-3 border border-gray-700/50 shadow-lg">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`flex-1 bg-gradient-to-r from-gray-700/90 to-gray-800/90 hover:from-red-600 hover:to-red-700 text-white py-2 px-3 rounded-lg border border-gray-600 hover:border-red-500 transition-all duration-200 shadow-lg hover:shadow-red-500/50 flex items-center justify-center gap-2 group text-sm ${activeButton === 'zoomin' ? 'from-red-600 to-red-700 border-red-500' : ''}`}
          >
          ...
          <button
            ...
            className={`flex-1 bg-gradient-to-r from-gray-700/90 to-gray-800/90 hover:from-red-600 hover:to-red-700 text-white py-2 px-3 rounded-lg border border-gray-600 hover:border-red-500 transition-all duration-200 shadow-lg hover:shadow-red-500/50 flex items-center justify-center gap-2 group text-sm ${activeButton === 'zoomout' ? 'from-red-600 to-red-700 border-red-500' : ''}`}
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-black/70 backdrop-blur-sm rounded-lg p-3 border border-gray-700/50 shadow-lg opacity-80">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`flex-1 bg-gradient-to-r from-gray-700/90 to-gray-800/90 hover:from-red-600 hover:to-red-700 text-white py-2 px-3 rounded-lg border border-gray-600 hover:border-red-500 transition-all duration-200 shadow-lg hover:shadow-red-500/50 flex items-center justify-center gap-2 group text-sm ${activeButton === 'focusnear' ? 'from-red-600 to-red-700 border-red-500' : ''}`}
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            onMouseUp={handleFocusStop}
            onMouseLeave={handleFocusStop}
            className={`flex-1 bg-gradient-to-r from-gray-700/90 to-gray-800/90 hover:from-red-600 hover:to-red-700 text-white py-2 px-3 rounded-lg border border-gray-600 hover:border-red-500 transition-all duration-200 shadow-lg hover:shadow-red-500/50 flex items-center justify-center gap-2 group text-sm ${activeButton === 'focusfar' ? 'from-red-600 to-red-700 border-red-500' : ''}`}
          >
      ...
      <div className="bg-black/70 backdrop-blur-sm rounded-lg p-3 border border-gray-700/50 shadow-lg opacity-80">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`flex-1 bg-gradient-to-r from-gray-700/90 to-gray-800/90 hover:from-red-600 hover:to-red-700 text-white py-2 px-3 rounded-lg border border-gray-600 hover:border-red-500 transition-all duration-200 shadow-lg hover:shadow-red-500/50 flex items-center justify-center gap-2 group text-sm ${activeButton === 'irisopen' ? 'from-red-600 to-red-700 border-red-500' : ''}`}
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
