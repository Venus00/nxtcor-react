...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
      <div className={`${sidebarWidthClass} h-[calc(100vh-8rem)] rounded-[16px] p-[16px] flex flex-col bg-white shadow border-2 `}>
      ...
      <div className="text-medium text-gray-500 w-full pl-4 bg-white shadow rounded-[16px] border-2 ">
