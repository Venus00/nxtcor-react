...
interface TamperDetectionProps {
  ...
  onConfigChange: (config: TamperDetectionConfig) => void;
  onSave: () => void;
}

const TamperDetection: React.FC<TamperDetectionProps> = ({
  config,
  onConfigChange,
  onSave,
}) => {
  ...
  const updateConfig = (updates: Partial<TamperDetectionConfig>) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-800/50 rounded-lg border border-gray-700 p-6">
        <div className="flex items-center justify-between">
          <div>
            <h4 className="text-white font-medium mb-1">Enable Tamper Detection</h4>
            <p className="text-gray-400 text-sm">
              Detect when the camera lens is covered, blocked, or physically tampered with
            </p>
          </div>
          <button
            onClick={() => updateConfig({ enabled: !config.enabled })}
            className={`relative inline-flex h-8 w-16 items-center rounded-full transition-all ${
              config.enabled ? 'bg-gradient-to-r from-orange-600 to-orange-700' : 'bg-gray-600'
            }`}
          >
            <span
        ...
        <>
          ...
          <div className="bg-gray-800/50 rounded-lg border border-gray-700 p-6">
            <label className="flex items-center justify-between text-white font-medium mb-3">
              ...
              <span className="text-orange-400 font-bold text-lg">{config.antiDither}s</span>
            </label>
            <input
              type="range"
              min="0"
              ...
              style={{
                background: `linear-gradient(to right, #EA580C 0%, #EA580C ${config.antiDither}%, #374151 ${config.antiDither}%, #374151 100%)`
              }}
            />
            <p className="text-gray-400 text-sm">
              Time interval to filter false alarms (0-100 seconds). Higher values reduce sensitivity to brief interruptions.
            </p>
          </div>
          ...
          <div className="bg-gray-800/50 rounded-lg border border-gray-700 p-6 space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-400 text-sm">Automatically record video when tamper is detected</p>
              </div>
              <button
            ...
            {config.record && (
              <div className="pt-4 border-t border-gray-700">
                ...
                />
                <p className="text-gray-400 text-sm">
                  Recording duration after tamper detection (10-300 seconds)
                </p>
              </div>
            )}
          </div>
          ...
          <div className="bg-gray-800/50 rounded-lg border border-gray-700 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-400 text-sm">Send email notification when tamper is detected</p>
              </div>
              <button
          ...
          <div className="bg-gray-800/50 rounded-lg border border-gray-700 p-6 space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-400 text-sm">Trigger PTZ action when tamper is detected</p>
              </div>
              <button
          ...
          <div className="bg-gray-800/50 rounded-lg border border-gray-700 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-400 text-sm">Capture image snapshot when tamper is detected</p>
              </div>
              <button
          ...
          <div className="bg-gray-800/50 rounded-lg border border-gray-700 p-6">
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="text-gray-400 text-sm">Configure time periods for tamper detection</p>
              </div>
              <button
          ...
          <div className="bg-gray-800/50 rounded-lg border border-gray-700 p-6">
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="text-gray-400 text-sm">Configure specific areas for tamper detection</p>
              </div>
              <button
      ...
      <div className="flex justify-end">
        <button
          onClick={onSave}
          className="py-3 px-8 bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-500 hover:to-orange-600 text-white rounded-lg transition-all font-medium shadow-lg transform hover:scale-105"
        >
          Save Configuration
        </button>
      </div>
